...
DJOSER = {
    ...
    'SERIALIZERS': {
        'token_create': 'glamour.serializers.CustomTokenCreateSerializer',
    }
}
...
ROOT_URLCONF = 'glamourhaven.urls'
...
WSGI_APPLICATION = 'glamourhaven.wsgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'glamour.token_authentication.ExpiringTokenAuthentication',
